...
```text
louis berenyi
2nd year cs @ uottawa · co-op stream · toronto
ml · research · fullstack
```
...
![neovim](https://img.shields.io/badge/-neovim-161b22?style=flat-square&logo=neovim&logoColor=white)
---

![contributions](./profile/assets/contributions.svg)
